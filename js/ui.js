...
function toggleLoading(isLoading) {
  ...
  var SearchIcon = document.getElementById("searchButton").getElementsByTagName("i")[0];
  var SearchButtonText = document.getElementById("searchButton").getElementsByTagName("span")[0];
